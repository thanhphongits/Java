...
//            String[] lbName = new String[]{"Mã nhân viên", "Họ nhân viên", "Tên nhân viên", "Ngày sinh", "Số điện thoại", "Giới tính", "Trạng thái"};
    ...
    public void check(JTextField tx){
        ...
        if (tx.equals(txTennv)) {
            if (tx.getText().trim().length() > 30||tx.getText().contains(" ")) {
                tx.setForeground(Color.red);
                btnThem.setEnabled(false);
                btnSua.setEnabled(false);
                return;
        ...
        int k=0;
        if(txHonv.getForeground().equals(Color.red)){
            k=1;
        }
        if(txTennv.getForeground().equals(Color.red)){
            k=1;
        }
        if(txSDT.getForeground().equals(Color.red)){
            k=1;
        }
        if(k==1){
            btnThem.setEnabled(false);
    ...
    public ArrayList<QuyenDTO> getListQ() {
        return listQ;
    }

    public void setListQ(ArrayList<QuyenDTO> listQ) {
        this.listQ = listQ;
    }
    ...
    public NhanVienBUS getQlNhanVien() {
        return qlNhanVien;
    }

    public void setQlNhanVien(NhanVienBUS qlNhanVien) {
        this.qlNhanVien = qlNhanVien;
    }

    public NhanVienDTO getNvsua() {
        return nvsua;
    }

    public void setNvsua(NhanVienDTO nvsua) {
        this.nvsua = nvsua;
    }

    public JTextField getTxManv() {
        return txManv;
    }

    public void setTxManv(JTextField txManv) {
        this.txManv = txManv;
    }

    public JTextField getTxHonv() {
        return txHonv;
    }

    public void setTxHonv(JTextField txHonv) {
        this.txHonv = txHonv;
    }

    public JTextField getTxTennv() {
        return txTennv;
    }

    public void setTxTennv(JTextField txTennv) {
        this.txTennv = txTennv;
    }
    ...
    public void setTxNgaysinh(JTextField txNgaysinh) {
        this.txNgaysinh = txNgaysinh;
    }

    public JTextField getTxSDT() {
        return txSDT;
    }

    public void setTxSDT(JTextField txSDT) {
        this.txSDT = txSDT;
    }
    ...
    public void setCbChonTrangThai(JComboBox<String> cbChonTrangThai) {
        this.cbChonTrangThai = cbChonTrangThai;
    }

    public JComboBox<String> getCbChonGT() {
        return cbChonGT;
    }

    public void setCbChonGT(JComboBox<String> cbChonGT) {
        this.cbChonGT = cbChonGT;
    }

    public JComboBox<String> getCbChonQuyen() {
        return cbChonQuyen;
    }

    public void setCbChonQuyen(JComboBox<String> cbChonQuyen) {
        this.cbChonQuyen = cbChonQuyen;
    }
    ...
    public DatePicker getdPickerNgaySinh() {
        return dPickerNgaySinh;
    }

    public void setdPickerNgaySinh(DatePicker dPickerNgaySinh) {
        this.dPickerNgaySinh = dPickerNgaySinh;
    }
